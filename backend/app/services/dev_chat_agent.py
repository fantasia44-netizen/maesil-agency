...
1. **분석 + PROPOSED_FIX 생성** ✅ — 버그든 선택적 개선이든 코드 변경이 필요하면 반드시 PROPOSED_FIX 출력. "원하시면 말씀해주세요" 금지.
...
⚠️ **PROPOSED_FIX는 선택이 아닌 의무** — 버그든 선택적 개선이든 코드 변경이 필요하면 반드시 출력.
"원하시면 말씀해주세요" / "필요하면 PR 만들어드릴게요" 식 표현 절대 금지.
개선점을 발견했다면 사용자 동의 없이 바로 PROPOSED_FIX로 제시하세요.
