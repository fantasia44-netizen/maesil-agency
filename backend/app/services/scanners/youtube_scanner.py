...
# 인터뷰/출연(campaign='interview') 전용 검색어 — 매실K가 게스트로 나갈
# 대담·인터뷰·창업스토리 채널을 찾기 위한 키워드(파트너 모집 키워드와 분리).
INTERVIEW_KEYWORDS = [
    # 셀러/이커머스 인터뷰
    "셀러 인터뷰",
    "쿠팡셀러 인터뷰",
