...
export default function GblLogin() {
  ...
  const linkBtn: React.CSSProperties = {
    background: "none", border: "none", color: "#8ea0c4", cursor: "pointer", fontSize: "0.8rem", padding: 0,
  };
  ...
  return (
    <div style={{ minHeight: "100dvh", display: "flex", alignItems: "center", justifyContent: "center",
      ...
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        {mode === "forgot" ? (
          sent ? (
            <div style={{ textAlign: "center", color: "#86efac", fontSize: "0.9rem", lineHeight: 1.7 }}>
              ✅ 재설정 링크를 이메일로 보냈습니다.<br />
              <span style={{ color: "#8ea0c4", fontSize: "0.82rem" }}>메일함(스팸함 포함)을 확인하세요. 링크는 30분간 유효합니다.</span>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <p style={{ margin: "0 0 2px", fontSize: "0.85rem", color: "#8ea0c4" }}>가입한 이메일로 재설정 링크를 보냅니다.</p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <p style={{ textAlign: "center", margin: "2px 0 0", fontSize: "0.72rem", color: "#5f6f92" }}>
              로그인 아이디는 가입한 이메일입니다.
            </p>
          </div>
        )}

        <p style={{ textAlign: "center", marginTop: 22, fontSize: "0.72rem", color: "#5f6f92" }}>
          내 기록은 내 계정에만 저장됩니다 · <Link href="/gbl/privacy" style={{ color: "#8ea0c4" }}>개인정보처리방침</Link>
        </p>
      </div>
    </div>
  );
