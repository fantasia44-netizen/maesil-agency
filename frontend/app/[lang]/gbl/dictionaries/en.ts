...
const en: Dict = {
  meta: {
    ...
    ogTitle: "GBL Note — Pokémon GO Raids, Battle, Tiers & CP All-in-One",
  ...
  landing: {
    ...
    cards: {
      ...
      ivDeep: { t: "Compromise-IV Analysis", d: "Build-worthy IV line from a full top-100 sim (CMP · Best Buddy)", tag: "Deep" },
