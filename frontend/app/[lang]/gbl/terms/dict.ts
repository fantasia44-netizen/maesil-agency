...
const zhTW: TermsDict = {
  title: "使用條款",
  effectiveLabel: "生效日",
  articles: [
    { h: "第1條（目的·適用）", lines: ["本條款訂定 GBL Note（以下稱「本服務」，gblnote.com）的使用條件與使用者·營運者的權利·義務。使用本服務即視為同意本條款。"] },
    { h: "第2條（服務內容）", lines: ["本服務為提供寶可夢 GO 對戰聯盟（GBL）相關對戰對手記錄·查詢、實測環境統計、強度·招式·剋星資訊等的免費網路服務。部分內容無需登入即可使用。"] },
    { h: "第3條（帳號）", lines: [
      "• 使用者須以正確資訊註冊，並負責自行安全管理帳號資訊（密碼等）。",
      "• 一個帳號由多人共用可能受到限制。",
      "• 使用者可隨時退出，退出時帳號·記錄將被銷毀。",
    ] },
    { h: "第4條（使用者的義務·禁止行為）", lines: [
      "使用者不得為下列行為。",
      "• 大量輸入不實·竄改資料以扭曲統計的行為",
      "• 冒充他人、未經同意蒐集·公開他人個人資料",
      "• 以自動化方式過度查詢·蒐集本服務或使伺服器負載的行為",
      "• 妨礙服務營運或違反相關法令的行為",
    ...
    { h: "第8條（免責）", lines: [
      ...
      "• 作為免費服務，營運者於相關法令允許範圍內，對使用服務所生之損害不負責任。",
    ] },
    { h: "第9條（智慧財產權）", lines: ["本服務的設計·程式·編輯物之權利歸營運者所有。寶可夢（Pokémon）、寶可夢 GO 等遊戲相關名稱·圖像之權利屬於各權利方，本服務以資訊提供為目的處理相關資訊。"] },
    { h: "第10條（準據法·管轄）", lines: ["本條款以大韓民國法律為準據法，爭議依相關法令由管轄法院解決。"] },
  ],
  contactHead: "第11條（洽詢）",
  contactSuffix: "條款·服務相關洽詢：",
  contactPageLink: "聯絡頁面",
  changeNote: "本條款可能依相關法令·政策變更，變更時將於本頁公告。",
};

const TERMS = { ko, en, ja, "zh-TW": zhTW } as const;
