...
const ko: TradeDict = {
  ...
  bgSection: "🎨 배경 (포켓몬마다)", bgLegendGroup: "전설 (GO투어·고페)", bgEventGroup: "이벤트·우주", bgRegionGroup: "지역", bgSceneGroup: "풍경", bgTypeGroup: "타입", tapApplyBg: "탭=선택한 배경 적용 · ✕ 삭제",
...
const en: TradeDict = {
  ...
  bgSection: "🎨 Background (per Pokémon)", bgLegendGroup: "Legendary (GO Tour · Fest)", bgEventGroup: "Event · Cosmic", bgRegionGroup: "Region", bgSceneGroup: "Scenery", bgTypeGroup: "Type", tapApplyBg: "Tap = apply background · ✕ remove",
...
const ja: TradeDict = {
  ...
  bgSection: "🎨 背景(ポケモンごと)", bgLegendGroup: "伝説(GOツアー・フェス)", bgEventGroup: "イベント・宇宙", bgRegionGroup: "地域", bgSceneGroup: "風景", bgTypeGroup: "タイプ", tapApplyBg: "タップ=選択中の背景を適用 · ✕ 削除",
...
const zhTW: TradeDict = {
  ...
  background: "背景", bgBadge: "",
  bgSection: "🎨 背景（每隻寶可夢）", bgLegendGroup: "傳說（GO Tour·Fest）", bgEventGroup: "活動·宇宙", bgRegionGroup: "地域", bgSceneGroup: "風景", bgTypeGroup: "屬性", tapApplyBg: "點擊＝套用選取的背景 · ✕ 刪除",
