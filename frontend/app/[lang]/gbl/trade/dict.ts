...
const zhTW: TradeDict = {
  navBack: "← GBL Note",
  h1: "寶可夢 GO 交換清單·交換圖產生器",
  intro: "選擇想要的寶可夢與可以給的寶可夢，製作交換清單·交換圖（交換製圖）。可加入異色·造型·極巨化，分享到社團·開放聊天室。",
  ...
  metaTitle: "寶可夢GO 交換清單·交換圖產生器 · 異色交換製圖 | GBL Note",
  metaDesc: "製作寶可夢 GO 交換清單·交換圖（交換製圖）。想要的·可以給的·異色·造型·極巨化·訓練家代碼一應俱全。社團·開放聊天室分享用圖片產生器。",
  ogTitle: "寶可夢GO 交換清單·交換圖產生器", ogDesc: "加入造型·異色製作交換清單·交換圖",
};
