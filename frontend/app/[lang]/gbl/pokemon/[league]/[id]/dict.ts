...
const ko: PokeDict = {
  ...
  countersH: "카운터 · 약점을 찌르는 상대", countersP: "이 포켓몬을 상대로 유리한 포켓몬입니다. 자주 만난다면 아래를 준비하세요.",
  winsH: "유리한 상대", winsP: "이 포켓몬으로 유리하게 상대할 수 있는 포켓몬입니다.", noData: "데이터 없음",
...
const en: PokeDict = {
  ...
  countersH: "Counters · what beats it", countersP: "Pokémon favored against this one. If you meet it often, prepare the below.",
  winsH: "Beats · favorable targets", winsP: "Pokémon you can favorably beat with this one.", noData: "No data",
...
const ja: PokeDict = {
  ...
  countersH: "対策・カウンター · 弱点を突く相手", countersP: "この相手に有利なポケモンです。よく遭遇するなら下記を準備。",
  winsH: "有利な相手", winsP: "このポケモンで有利に戦える相手です。", noData: "データなし",
  ...
  metaTitle: "技構成・対策・ティア攻略 | GBL Note", metaDesc: "推奨技構成と弱点対策(カウンター)、ティア、主要な有利・不利対面、そして実測ピック率(直近30日)まで。理論シミュ+実戦データで、このリーグでの実際の使われ方を確認。",
  ogDescSuffix: "対策・推奨技・実測ピック率", ogTitleSuffix: "対策・技構成",
  share: {
...
const zhTW: PokeDict = {
  ...
  movesetH: "推薦配招 · 招式次數", fastLabel: "一般招式", fastTurns: "回合 · 能量 +", chargedHint: "特殊招式 — 連續發動時的次數（含能量結轉）", hitsUnit: "次", energyUnit: "能量", recTag: "推薦", altFastHint: "↑ 點擊一般招式切換 — 次數重新計算",
  countersH: "剋星 · 剋制的對手", countersP: "對這隻寶可夢佔優勢的寶可夢。若常遇到，請準備下方這些。",
  winsH: "佔優勢的對手", winsP: "用這隻寶可夢可佔優勢對付的寶可夢。", noData: "無資料",
  ...
  explainer: "推薦配招以公開對戰模擬(PvPoke)為準，剋星·佔優對手依模擬對面結果整理。實測使用率是 GBL Note 使用者實際遇到對手的匿名統計。",
  explainerTierWord: "強度", recordLink: "記錄我的戰績 →", privacy: "隱私權政策",
  metaTitle: "配招·剋星·強度攻略 | GBL Note", metaDesc: "推薦配招（招式配置）與弱點剋星、強度、主要勝負對面，以及玩家實測使用率（近30天）。用模擬理論＋實戰數據，確認這隻在此聯盟的實際用法。",
  ogDescSuffix: "剋星·推薦配招·實測使用率", ogTitleSuffix: "剋星·配招",
  share: {
    movesetH: "推薦配招 · 招式次數", statsH: "種族值", atk: "攻擊", def: "防禦", hp: "HP",
