...
const zhTW: AppDict = {
  gateH1: "📝 我的對戰記錄", gateTitle: "會員專用功能", gateDescPre: "我的對戰記錄·戰績管理僅供 ", gateDescBold: "註冊會員", gateDescPost: " 使用。",
  gateDesc2: "免費註冊後即可管理對手記錄·我的戰績。", gateBtn: "註冊 / 登入",
  navRaid: "🔥 團體戰", navMeta: "🌐 環境", logout: "登出",
  nickTitle: "修改暱稱（顯示於戰績卡）", nickSet: "設定暱稱",
  playsSuffix: "場", winSuffix: "勝", lossSuffix: "敗", drawSuffix: "平", timesSuffix: "次",
  tabLookup: "🔍 查詢", tabLog: "✏️ 記錄", tabStats: "📊 戰績",
  tabProfile: "👤 個人檔案", profileHint: "全季通算 — 依季節分開檢視（僅進入時載入全部）。", profileAll: "全部", profileLifetime: "通算", profileSeasonN: "第 {n} 季",
  scopeMine: "我的記錄", scopeAll: "🌐 全體使用者",
  searchPlaceholder: "對手訓練家名稱幾個字…",
  sortRecent: "🕒 對戰順", sortName: "🔤 名稱順",
  loading: "載入中…",
  emptyMatch: "沒有符合的對手記錄。",
  emptyNone: "還沒有記錄。用「對戰後記錄」留下第一位對手吧。",
  editingBanner: "✏️ 記錄修改中 — 修正輸入錯誤的內容後按「儲存修改」。",
  oppLabel: "對手訓練家名稱", oppPlaceholder: "例：PikaMaster99",
  resWin: "勝", resLoss: "敗", resUndecided: "未定",
  memoLabel: "整體備註（回合/護盾等）",
  memoPlaceholder: "例：先發巨金怪，用 2 盾誘地震。後排暴鯉龍/波克基斯。",
  cancel: "取消", reset: "重置",
  saving: "儲存中…", saveEdit: "儲存修改", saveNew: "儲存記錄",
  slotPre: "第 ", slotSuf: " 隻",
  fastLabel: "一般招式", chargedLabel: "特殊招式（最多 2）",
  notePlaceholder: "個體備註（例：第 3 下地震，用了護盾）",
  manualPlaceholder: "手動輸入（清單外的個體）",
  listBtn: "清單", changeBtn: "變更",
  searchMonPlaceholder: "搜尋寶可夢（中文）",
  notInList: "+ 清單沒有（手動輸入）",
  shadowWord: "暗影 ",
  edit: "修改", del: "刪除",
  periodToday: "今天", period7: "7 天", period30: "30 天", periodSeason: "本季", periodAll: "全部",
  totalPlays: "總場數", record: "戰績", winRate: "勝率",
  makeCard: "📸 製作戰績卡 · 炫耀",
  ratingTrend: "📈 積分走勢", addAccount: "+ 帳號",
  currentScore: "目前分數", recordBtn: "記錄", currentWord: "目前",
  needTwo: "記錄 2 次以上才會出現走勢圖。",
  weekdays: ["日", "一", "二", "三", "四", "五", "六"],
  calLegendPre: "顏色 = 當日勝率（綠好·黃普·紅差）· 數字 = 勝-敗 · ",
  calLegendBold: "點日期 → 當日對手",
  closeX: "關閉 ✕",
  dayWinRate: "📊 每日勝率",
  mostMetPre: "最常遇到順 · ", deckKindsSuf: "種隊伍",
  emptyNoRecord: "還沒有記錄。", emptyNoDeck: "沒有符合的隊伍。",
  deckAll: "全部隊伍", deckWon: "🟢 贏的隊伍", deckLost: "🔴 輸的隊伍",
  reviewPre: "複盤 — ",
  profileDefault: "預設", ratingWord: "積分",
  shareTitle: "我的 GBL 戰績", shareText: "我的寶可夢GO 對戰戰績 · gblnote.com",
  shareSaved: "💾 已儲存",
  shareNoSupport: "此瀏覽器無法直接分享。請將已儲存的圖片附加到通訊軟體·郵件。",
  shareFallback: "已改為儲存 — 請附加圖片分享",
  share: "📤 分享", save: "💾 儲存", close: "關閉",
  nickPrompt: "暱稱（顯示於戰績卡·炫耀）",
  nickEmpty: "請輸入暱稱",
  nickTooLong: "暱稱須在 20 字以內",
  nickChanged: "暱稱已變更",
  changeFailPre: "變更失敗：", errWord: "錯誤",
  loadFail: "載入失敗", loadAllFail: "全部記錄載入失敗",
  ratingBadInput: "請正確輸入分數", ratingRecorded: "📈 積分已記錄",
  saveFail: "儲存失敗",
  accountPrompt: "帳號名稱（例：分身1）",
  needOppName: "請輸入對手名稱。",
  editSaved: "✅ 已修改", recordSaved: "✅ 記錄已儲存",
};
