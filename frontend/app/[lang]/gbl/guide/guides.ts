...
export const GUIDES: Record<string, Guide> = {
  ...
  "moveset": {
    ...
    keywords: {
      ...
      "zh-TW": ["寶可夢GO 配招", "PvP 配招", "招式配置", "配招推薦", "一般招式 特殊招式", "寶可夢GO 誘騙", "DPT EPT"],
    },
    ko: {
    ...
    "zh-TW": {
      title: "寶可夢GO 配招選擇法（招式配置） — 一般·特殊招式·誘騙",
      desc: "整理寶可夢GO PvP配招（招式配置）的選擇標準。一般招式的DPT·EPT·回合數、特殊招式的能量·威力·效果、本系與打點，以及護盾誘騙——數據如何決定推薦配招。",
      sections: [
