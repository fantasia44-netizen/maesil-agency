...
const ko: TcgDict = {
  ...
  nav: [
    ...
    { key: "guide", path: "/tcg/guide", label: "가이드" },
  ],
  hero: {
  ...
  signature: {
    ...
    items: [
      ...
      { t: "🎴 팩 확률 분석", d: "어느 팩에서 어떤 카드가 얼마 확률로 나오는지 데이터로 정리", href: "/tcg/guide" },
    ],
  },
...
const en: TcgDict = {
  ...
  nav: [
    ...
    { key: "guide", path: "/tcg/guide", label: "Guides" },
  ],
  hero: {
  ...
  funnel: [
    ...
    { path: "/tcg/guide", label: "Strategy Guides" },
  ],
  signature: {
    ...
    items: [
      ...
      { t: "🎴 Pull-rate analysis", d: "Which pack drops which card, at what odds — from data", href: "/tcg/guide" },
    ],
  },
...
const ja: TcgDict = {
  ...
  nav: [
    ...
    { key: "guide", path: "/tcg/guide", label: "ガイド" },
  ],
  hero: {
  ...
  signature: {
    ...
    items: [
      ...
      { t: "🎴 パック確率分析", d: "どのパックでどのカードがどの確率で出るかをデータで整理", href: "/tcg/guide" },
    ],
  },
...
const zhTW: TcgDict = {
  ...
  nav: [
    ...
    { key: "guide", path: "/tcg/guide", label: "指南" },
  ],
  hero: {
  ...
  signature: {
    ...
    items: [
      ...
      { t: "🎴 卡包機率分析", d: "哪個卡包以多少機率抽到哪張卡，用數據整理", href: "/tcg/guide" },
    ],
  },
