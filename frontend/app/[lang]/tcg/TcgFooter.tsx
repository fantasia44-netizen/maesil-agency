...
const T: Record<Locale, { about: string; privacy: string; terms: string; disclaimer: string }> = {
  ko: { about: "소개", privacy: "개인정보처리방침", terms: "이용약관", disclaimer: "TCG Note는 팬 제작 비공식 사이트입니다. 포켓몬 관련 권리는 각 권리자에게 있습니다. 덱 통계 출처: Limitless TCG." },
  en: { about: "About", privacy: "Privacy", terms: "Terms", disclaimer: "TCG Note is an unofficial fan-made site. Pokémon rights belong to their respective owners. Deck stats: Limitless TCG." },
  ja: { about: "概要", privacy: "プライバシー", terms: "利用規約", disclaimer: "TCG Note はファン制作の非公式サイトです。ポケモン関連の権利は各権利者に帰属します。デッキ統計出典: Limitless TCG。" },
  "zh-TW": { about: "關於", privacy: "隱私權", terms: "使用條款", disclaimer: "TCG Note 為粉絲製作非官方網站。寶可夢相關權利歸各權利人。牌組統計來源: Limitless TCG。" },
};
