...
export const GUIDES: Guide[] = [
  {
    ...
    i18n: {
      ko: {
        ...
        summary: "카드를 나열하는 사이트는 많습니다. TCG Note는 공개 데이터로 '계산된 답'을 만듭니다. 무엇이 다르고 어떻게 200% 쓰는지 정리.",
        sections: [
  ...
  },
  {
    ...
    i18n: {
      ko: {
        ...
        summary: "핵심 카드가 첫 손에 잡힐 확률, 콤보가 갖춰질 확률을 몬테카를로로 계산. 계산 원리와 덱을 짜고 고를 때 쓰는 법을 정리했습니다.",
        sections: [
  ...
  },
  {
    ...
    i18n: {
      ko: {
        ...
        summary: "'계산한 확률'과 '실제 대회 승률'은 서로 다른 것을 측정합니다. 어떻게 다르고 함께 보면 뭘 알 수 있는지 실제 데이터로 설명.",
        sections: [
  ...
  },
  {
    ...
    i18n: {
      ko: {
        ...
        summary: "실제 공개 확률(pull rate)로 팩을 열어보는 시뮬레이터. 작동 원리와, 목표 카드를 위해 젬을 어디에 쓸지 계획하는 법을 정리.",
        sections: [
  ...
  },
  {
    ...
    i18n: {
      ko: {
        ...
        summary: "타입 분포·상위 집중도·오버퍼포머까지 대회 데이터로 현재 메타를 읽는 법. 덱을 고르기 전에 '지금 뭐가 강한가'를 파악하세요.",
        sections: [
  ...
  },
  {
    ...
    i18n: {
      ko: {
        ...
        summary: "상대 덱을 고르면 실제 대회 매치업 승률로 그 덱을 이기는 카운터를 찾아줍니다. 감이 아니라 실측으로 상성을 읽는 법.",
        sections: [
  ...
  },
  {
    ...
    i18n: {
      ko: {
        ...
        summary: "티어를 왜 단순 승률이 아니라 표본과 Wilson 하한으로 산출하는지, 승률·표본 숫자를 어떻게 읽어야 속지 않는지 정리.",
        sections: [
