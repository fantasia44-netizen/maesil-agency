...
const A: Record<string, Partial<Record<Locale, DeckAnalysis>>> = {
  ...
  "mega-lucario-ex-b3-lucario-a2": {
    ko: {
      ...
      gamePlan: "리오르–루카리오 라인을 빠르게 세우고 메가 루카리오 ex로 2~3턴 안에 공격을 시작합니다. 상대 벤치를 지목·강제교체(초련·태홍 등)로 원하는 대상을 앞으로 끌어내 급소를 노리고, 컨트롤 덱이 안정되기 전에 게임을 끝내는 레이스형 운영이 정석입니다.",
      keyCards: ["메가 루카리오 ex — 주력 어태커", "리오르/루카리오 — 진화 세팅", "박사의 연구 — 드로우 엔진", "초련·X 스피드 — 지목·기동"],
    ...
    ja: {
      ...
      gamePlan: "リオル–ルカリオのラインを素早く並べ、2〜3ターンでメガルカリオexの攻撃を開始。ベンチ指名・強制入れ替え(ナツメ等)で狙った相手を引きずり出し、コントロールが安定する前に決めるレース型が基本です。",
      keyCards: ["メガルカリオex — 主力アタッカー", "リオル/ルカリオ — 進化セット", "博士の研究 — ドローエンジン", "ナツメ・Xスピード — 指名・機動"],
      techCards: ["追加の指名カード — ベンチ狙撃を強化", "ダメージ補正カード — 重要HPラインを調整", "先攻・機動カード — ミラー/コントロール対策"],
    },
    "zh-TW": {
      playstyle: "格鬥快攻",
      summary: "目前使用率第一的格鬥快攻牌組。核心是從前期就施壓，在對手站穩之前搶下分數。",
      gamePlan: "快速鋪好利歐路–路卡利歐進化線，第2~3回合就用超級路卡利歐ex開始進攻。用指名·強制交換(娜姿等)把想打的目標拉到前排，趕在控制牌組穩住之前結束比賽。",
      keyCards: ["超級路卡利歐ex — 主力攻擊手", "利歐路/路卡利歐 — 進化鋪陳", "博士的研究 — 抽牌引擎", "娜姿·X速度 — 指名·機動"],
  ...
  "suicune-ex-a4a-baxcalibur-b2a": {
    ko: {
      ...
      summary: "드닐레이브로 에너지를 가속해 스이쿤 ex를 빠르게 가동하는 물 덱. 점유율은 높지만 승률은 50% 안팎이라 운영 정밀도가 성패를 가릅니다.",
      gamePlan: "드닐레이브의 에너지 가속으로 스이쿤 ex를 남보다 한 박자 빨리 세워 템포를 잡습니다. 가속이 걸리면 강력하지만 세팅이 어긋나면 손해가 크므로, 드로우로 일관성을 확보하고 무리한 전개를 피하는 것이 중요합니다.",
      keyCards: ["스이쿤 ex — 주력 어태커", "드닐레이브 — 에너지 가속", "물 에너지 · 드로우 트레이너"],
    },
    en: {
    ...
    ja: {
      ...
      summary: "セグレイブでエネ加速し、スイクンexを早期起動する水デッキ。使用率は高いが勝率は50%前後で、回しの精度が勝敗を分けます。",
      gamePlan: "セグレイブの加速でスイクンexを一手早く立ててテンポを握ります。加速が決まれば強力ですが、セットが崩れると損失が大きいので、ドローで一貫性を確保し無理な展開を避けます。",
      keyCards: ["スイクンex — 主力アタッカー", "セグレイブ — エネ加速", "水エネルギー・ドロー"],
    },
    "zh-TW": {
      playstyle: "水系加速·中速",
      summary: "以戟脊龍加速能量、快速啟動水君ex的水系牌組。使用率高但勝率約五五波，操作精度決定勝負。",
      gamePlan: "用戟脊龍的加速比對手早一步立起水君ex搶節奏。加速到位時強力、鋪不順時損失大，因此要靠抽牌確保穩定、避免過度展開。",
      keyCards: ["水君ex — 主力攻擊手", "戟脊龍 — 能量加速", "水能量·抽牌訓練家"],
    },
  },
