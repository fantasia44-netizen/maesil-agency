...
export default function robots(): MetadataRoute.Robots {
  ...
  // tcgnote: AdSense 승인 전엔 카드 상세 3,879장을 심사 크롤러(Mediapartners-Google + 심사 샘플링에 쓰이는 AdsBot-Google) 시야에서 제외.
  ...
  return {
    rules: [
      ...
      ...(isTcg && !cardsOpen ? [{ userAgent: ["Mediapartners-Google", "AdsBot-Google"], disallow: ["/tcg/cards/", "/en/tcg/cards/", "/ja/tcg/cards/", "/zh-TW/tcg/cards/"] }] : []),
    ],
