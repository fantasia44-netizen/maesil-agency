...
- **AI**: Anthropic Claude (Haiku — 빠른 응답/CS, Sonnet — 코드 분석)
...
├── services/
│   ├── maeyo_engine.py          — L1/L2/L3 CS 엔진 (L2: DB 스크립트+프로그램별 캐시, L3: Claude Haiku)
...
L2 — DB 스크립트 조회 (프로그램별 캐시, Claude 비용 없음)
L3 — Claude Haiku (L1/L2 미매칭 시 폴백)
```
